...
def parse_args():
    ...
    parser.add_argument('--reversed_list', type=int, default=1, help='Whether this run is for reproduction, if set to True, the random seed would be fixed (defaults to True)')
