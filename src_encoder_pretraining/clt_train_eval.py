...
def main(args):
    ...
    # Load dataset
    for dataset in ['INTERACTION_highD_ArgoverseHV_SafeBaseline']:
        ...
        run_dir = f'{path_prepared}EncoderPretraining/spclt/{dataset}/trained_models/'
        results_dir = f'{path_prepared}EncoderPretraining/spclt/{dataset}/evaluation.csv'
        ...
        tuned_params_dir = f'{path_prepared}EncoderPretraining/spclt/{dataset}/representation_hyperparameters.csv'
