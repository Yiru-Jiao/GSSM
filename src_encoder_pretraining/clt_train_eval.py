...
def parse_args():
    ...
    parser.add_argument('--model', type=int, default=None, help='Whether this run is for reproduction, if set to True, the random seed would be fixed (defaults to True)')
...
def main(args):
    ...
    run_dir = f'{path_prepared}EncoderPretraining/spclt/SafeBaseline/trained_models/'
    results_dir = f'{path_prepared}EncoderPretraining/spclt/SafeBaseline/evaluation.csv'
    ...
    tuned_params_dir = f'{path_prepared}EncoderPretraining/spclt/SafeBaseline/representation_hyperparameters.csv'
